...
def task_fn():
    env = PortfolioEnv(df=df_train, steps=steps, window_length=window, utility='Log', output_mode='EIIE', gamma=1,
...
config.replay_fn = lambda: ReplayAlpha(memory_size=10000, batch_size=64)
