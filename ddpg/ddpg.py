...
# agent10 =agent
agent.worker_network.load_state_dict(torch.load(log_dir_10))
...
# df_v[["portfolio_value", "market_value"]].plot()
# df_v['CVaR'].plot()
# plt.show()

# log_dir = '/Users/Morgans/Desktop/trading_system/video/DDPGAgent-ddpg-cnn-agent-ETF-win7-etf_chn2.pth'
# agent.save(log_dir)
#
# torch.save(agent.worker_network.state_dict(), log_dir)

# torch.save(agent.worker_network, log_dir)
# df_v.plot(y=['portfolio_value','market_value'], use_index=True)
# plt.show()
# Out[15]: '/Users/Morgans/Desktop/trading_system/video/DDPGAgent-ddpg-20210312_15-29-11-model-DDPGEnv.bin'
