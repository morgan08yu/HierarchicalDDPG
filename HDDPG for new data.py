    ...
    def episode(self, deterministic=False, video_recorder=None):
        ...
        while True:
            ...
            if not deterministic and self.replay_Hierachical.size() >= config.min_memory_size:
                ...
                critic_loss_H = self.criterion(q_H, q_next_H)  # adding new criterion for Hierachical
                # #TD error
...
config1.save_interval = config1.episode_limit = 50
...
# log_dir_H = '/Users/Morgans/Desktop/trading_system/video/addtional data weight/HiAgent-ddpg_cvar_win5_c5_etf.pth'
