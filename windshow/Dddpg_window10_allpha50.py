...
config.replay_fn = lambda: ReplayAlpha(memory_size=int(1e5), batch_size=64)
...
# log_dir = '/Users/Morgans/Desktop/trading_system/video/addtional data weight/DDDPGAgent-win10_alpha50_weights.pth'
# agent.save(log_dir)
#